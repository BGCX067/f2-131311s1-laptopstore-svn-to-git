    ...
    <div id="right"> <!-- InstanceBeginEditable name="Main_Content" -->
    	...
    	<div class="panel panel-primary">
        	<div class="panel-body">
            	<img src="../images/Samsung_1.jpg" width="150" height="150" />
                <br/>
                <label class="price">Price : 1000$</label>
                <br/>
                <label class="name"><a href="product_detail.asp">Name : Mac Book Pro</a></label>
                <br/>
