...
<div id="wrapper">
  ...
  <div id="body">
    ...
    <div id="right"> <!-- InstanceBeginEditable name="Main_Content" -->
		<h1>Laptop Sony Vaio Fit SVF1421QSG 33212G75W8</h1>
        <img src="../images/vaio_detail_1.jpg" width="500" height="400" />
        <table class="table table-condensed table-striped">
        	<tr>
            	<td>CPU:</td>
                <td>Core i3,1.80 GHz</td>
            </tr>
            <tr>
            	<td>RAM/HDD:</td>
                <td>2 GB, 750 GB</td>
            ...
            <tr>
            	<td>Card MH:</td>
                <td>Intel® HD Graphics 4000, Share</td>
            </tr>
            <tr>
            	<td>Màn Hình:</td>
                <td>LED Blacklit, Reality, chế độ (Vivid, Natural, Text), 14 inch</td>
            </tr>
            <tr>
            	<td>HĐH:</td>
                <td>Windows 8 Single Language,64-bit</td>
            </tr>
            <tr>
            	<td>Cảm Ứng:</td>
                <td>Không</td>
